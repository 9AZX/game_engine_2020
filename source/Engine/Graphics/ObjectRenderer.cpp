...
void ObjectRenderer::createObjectRendererCPP(MeshType modelType, glm::vec3 _position, glm::vec3 _scale)
{
	...
	objBuffers.createVertexIndexUniformsBuffersCPP(modelType);
...
void ObjectRenderer::updateUniformBufferCPP(Camera camera)
{
	UniformBufferObject ubo = {};
